...
const PoolIcon = () => (
  <svg
    ...
    className="poolSvg"
    title="Басейн на територии"
  >
    <g>
      <path d="m7.5 254.5h497v150h-497z" fill="#2accf4" />
      <path d="m474.5 254.5h30v150h-30z" fill="#22b3eb" />
      <path d="m7.5 224.5h497v30h-497z" fill="#8aeeff" />
      <path d="m474.5 224.5h30v30h-30z" fill="#63e5ff" />
      <path
        d="m119 400h-30v-258c0-8.284 6.716-15 15-15 8.284 0 15 6.716 15 15z"
        fill="#f1f1f1"
      />
      <path
        d="m235 400h-30v-258c0-8.284 6.716-15 15-15 8.284 0 15 6.716 15 15z"
        fill="#f1f1f1"
      />
      <path
        d="m504.5 345.5c-20.711 0-20.711 17.341-41.423 17.341s-20.711-17.341-41.423-17.341c-20.709 0-20.709 17.341-41.417 17.341-20.709 0-20.709-17.341-41.418-17.341-20.708 0-20.708 17.341-41.417 17.341-20.708 0-20.708-17.341-41.416-17.341-20.705 0-20.705 17.341-41.411 17.341-20.708 0-20.708-17.341-41.415-17.341-20.708 0-20.708 17.341-41.417 17.341-20.708 0-20.708-17.341-41.416-17.341-20.707 0-20.707 17.341-41.414 17.341s-20.707-17.341-41.413-17.341v103c0 30.928 25.072 56 56 56h385c30.928 0 56-25.072 56-56z"
        fill="#b9f5ff"
      />
      <g fill="#8aeeff">
        <path d="m267.402 362.841c6.703 0 11.232-1.821 15-4.279-7.873-5.135-12.411-13.062-26.416-13.062-6.703 0-11.231 1.821-14.999 4.279 7.872 5.135 12.411 13.062 26.415 13.062z" />
        <path d="m350.237 362.841c6.703 0 11.232-1.821 15-4.278-7.874-5.135-12.412-13.063-26.418-13.063-6.703 0-11.231 1.821-15 4.279 7.874 5.134 12.412 13.062 26.418 13.062z" />
        <path d="m184.575 362.841c6.703 0 11.231-1.821 14.999-4.279-7.872-5.135-12.411-13.062-26.415-13.062-6.703 0-11.232 1.821-15 4.279 7.874 5.135 12.412 13.062 26.416 13.062z" />
        <path d="m433.077 362.841c6.703 0 11.232-1.82 15-4.277-7.876-5.135-12.414-13.064-26.423-13.064-6.703 0-11.231 1.821-14.999 4.278 7.876 5.135 12.414 13.063 26.422 13.063z" />
        <path d="m474.5 360.541v87.959c0 30.928-25.072 56-56 56h30c30.928 0 56-25.072 56-56v-103c-15.988 0-19.641 10.328-30 15.041z" />
        <path d="m18.913 362.841c6.703 0 11.232-1.821 15-4.279-7.872-5.135-12.41-13.062-26.413-13.062v15.045c3.058 1.39 6.695 2.296 11.413 2.296z" />
        <path d="m101.743 362.841c6.703 0 11.232-1.821 15-4.279-7.873-5.135-12.411-13.062-26.416-13.062-6.703 0-11.231 1.821-15 4.279 7.873 5.135 12.411 13.062 26.416 13.062z" />
      </g>
      <g fill="#d0d0d0">
        <path d="m119 154.5h86v30h-86z" />
        <path d="m119 224.5h86v30h-86z" />
        <path d="m119 294.5h86v30h-86z" />
      </g>
      <circle cx="398" cy="91" fill="#ffd54f" r="48" />
      <path
        d="m398 43c-5.24 0-10.279.851-15 2.404 19.161 6.3 33 24.327 33 45.596s-13.839 39.296-33 45.596c4.721 1.552 9.76 2.404 15 2.404 26.51 0 48-21.49 48-48s-21.49-48-48-48z"
        fill="#ffc128"
      />
      <g>
          ...
          <div className="list" ref={apartmentRef}>
            {apartmentsList.map(
              (
                ...
                <div
                  className={cn('apartment', index === activeIndex && 'active')}
                  key={originalLink}
                >
                  <div className="apartmentPicture">
                    <a href={originalLink} target="_blank">
                      <img src={imgLink} alt="" className="apartmentImg" />
                    </a>
                    <span className="apartmentRating">{rating} ⭐</span>
                    <span className="apartmentPrice">{price} UAH</span>
                  </div>
                  <div className="apartmentHeading">
                    <h2 className="apartmentTitle">{title}</h2>
                    <div className="advantages">
                      {pool && <PoolIcon />}
                      {beach && <span title="Пляж первая линия">🏖 </span>}
          ...
          {apartmentsList.map((item, index) => {
            ...
            return (
              <Marker
                ...
                label={activeIndex === index ? item.title : ''}
              />
            );
          })}
        </ApartmentMap>
